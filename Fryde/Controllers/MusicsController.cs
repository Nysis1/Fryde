...
namespace Fryde.Controllers
{
    public class MusicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ContentType,Name,Artist,FilePath")] Music music)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ContentType,Name,Artist,FilePath")] Music music)
        {
            if (id != music.Id)
            {
                return NotFound();
